...
ColumnLayout {
    ...
    property string countColor: pluginApi.pluginSettings.countColor ?? pluginApi.manifest.metadata.defaultSettings.countColor ?? "none"
    ...
    NTabView {
        ...
        ColumnLayout { // Bar Tab
            ...
            NColorChoice {
                visible: root.enableColorization
                label: pluginApi.tr("settings.bar.countColor.text")
                description: pluginApi.tr("settings.bar.countColor.desc")
                currentKey: root.countColor
                onSelected: key => root.countColor = key
            }
    ...
    function saveSettings() {
        ...
        pluginApi.pluginSettings.countColor = root.countColor
