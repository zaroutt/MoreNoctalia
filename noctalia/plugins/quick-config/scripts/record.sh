...
#
# Actions:
#   thumb        <src>                    — extract mid-frame thumbnail → /tmp/quick-config-record-thumb.png
...
set -euo pipefail
ACTION="${1:-}"
THUMB_OUT="/tmp/quick-config-record-thumb.png"
PALETTE="/tmp/quick-config-record-palette.png"
_require() {
