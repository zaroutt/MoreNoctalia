...
Singleton {
  ...
  property real panelFadeProgress: 1.0
  ...
  // Override de opacidade do painel (button 13) — reativo cross-context
  ...
  readonly property color barOutlineColor: Settings.data.bar.showBarOutline ? Color.mPrimary : "transparent"
  readonly property int barOutlineWidth: Settings.data.bar.showBarOutline ? Settings.data.bar.barOutlineWidth : 0
