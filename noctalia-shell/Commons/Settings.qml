  ...
  */
  ...
  JsonAdapter {
    ...
    property JsonObject bar: JsonObject {
      ...
      property bool showBarOutline: false
      property int barOutlineWidth: Style.borderS
      ...
      // Hover reveal settings (per-widget via widget config)
      property real hoverRevealOpacity: 0.3
      ...
      property list<var> capsuleGroupWidgets: []
      property bool capsuleGroupEnabled: false
      property string capsuleLeftColorKey: "none"
      property string capsuleCenterColorKey: "none"
      property string capsuleRightColorKey: "none"
      property real capsuleLeftOpacity: 0.3
      property real capsuleCenterOpacity: 0.3
      property real capsuleRightOpacity: 0.3
      property int capsuleOutlineWidth: 0
      property string capsuleCollapseTarget: "none"  // "none" | "left" | "center" | "right"
      property bool capsuleFillBar: false
      property int capsuleGroupSpacing: 6
      property bool capsuleIndividualColorsLeft: false
      property bool capsuleIndividualColorsCenter: false
      property bool capsuleIndividualColorsRight: false
      property int capsuleInnerPadding: 0
      property bool capsuleTranslucent: false
    ...
    property JsonObject ui: JsonObject {
      ...
      property real panelBackgroundOpacity: 0.5
      property bool panelOutlineEnabled: false
      property real panelOutlineWidth: 2.0
      property bool translucentWidgets: true
      property bool panelsAttachedToBar: true
      property real panelSnapCornerRadius: 0
      property string settingsPanelMode: "attached" // "centered", "attached", "window"
      property bool settingsPanelSideBarCardStyle: false
      property bool filledBackground: true
    }
  ...
  function upgradeWidget(widget) {
    ...
    for (const k of Object.keys(widget)) {
      ...
      // Preserve per-widget hover reveal setting (not in metadata yet)
      if (k === "hoverReveal") {
        continue;
      }
      if (!keys.includes(k)) {
