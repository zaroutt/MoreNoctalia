...
ShapePath {
  ...
  // When true, renders only the stroke (no fill) for the bar outline layer
  ...
  // When true AND isFramed: outer subpath becomes degenerate (invisible stroke).
  // Only the inner hole subpath (with frameRadius) produces a visible stroke.
  property bool outlineHoleOnly: false
  ...
  strokeWidth: strokeOnly ? Style.barOutlineWidth : 0
  strokeColor: strokeOnly ? Style.barOutlineColor : "transparent"
  fillColor: strokeOnly ? "transparent" : (isRenderable ? Qt.rgba(backgroundColor.r, backgroundColor.g, backgroundColor.b, backgroundColor.a * opacityFactor) : "transparent")
  ...
  PathLine {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? (root.screenWidth - root._minR) : (root.barMappedPos.x + root.barWidth + root.rightEdgeOvs - root.trRadius * root.trMultX)) : 0
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? 0 : (root.barMappedPos.y + root.topEdgeOvs)) : -1
  }

  // Top-right corner
  PathArc {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root.screenWidth : (root.barMappedPos.x + root.barWidth + root.rightEdgeOvs)) : 0
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : (root.barMappedPos.y + root.topEdgeOvs + root.trRadius * root.trMultY)) : -0.75
    radiusX: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.trRadius) : 0
    radiusY: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.trRadius) : 0
    direction: ShapeCornerHelper.getArcDirection(root.trMultX, root.trMultY)
  }

  PathLine {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root.screenWidth : (root.barMappedPos.x + root.barWidth + root.rightEdgeOvs)) : 0
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? (root.screenHeight - root._minR) : (root.barMappedPos.y + root.barHeight + root.bottomEdgeOvs - root.brRadius * root.brMultY)) : 0
  }

  // Bottom-right corner
  PathArc {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? (root.screenWidth - root._minR) : (root.barMappedPos.x + root.barWidth + root.rightEdgeOvs - root.brRadius * root.brMultX)) : -0.25
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root.screenHeight : (root.barMappedPos.y + root.barHeight + root.bottomEdgeOvs)) : 0
    radiusX: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.brRadius) : 0
    radiusY: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.brRadius) : 0
    direction: ShapeCornerHelper.getArcDirection(root.brMultX, root.brMultY)
  }

  PathLine {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : (root.barMappedPos.x + root.leftEdgeOvs + root.blRadius * root.blMultX)) : -1
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root.screenHeight : (root.barMappedPos.y + root.barHeight + root.bottomEdgeOvs)) : 0
  }

  // Bottom-left corner
  PathArc {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? 0 : (root.barMappedPos.x + root.leftEdgeOvs)) : -1
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? (root.screenHeight - root._minR) : (root.barMappedPos.y + root.barHeight + root.bottomEdgeOvs - root.blRadius * root.blMultY)) : -0.25
    radiusX: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.blRadius) : 0
    radiusY: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.blRadius) : 0
    direction: ShapeCornerHelper.getArcDirection(root.blMultX, root.blMultY)
  }

  PathLine {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? 0 : (root.barMappedPos.x + root.leftEdgeOvs)) : -1
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : (root.barMappedPos.y + root.topEdgeOvs + root.tlRadius * root.tlMultY)) : -1
  }

  // Top-left corner (back to start)
  PathArc {
    x: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : (root.barMappedPos.x + root.leftEdgeOvs + root.tlRadius * root.tlMultX)) : -0.75
    y: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? 0 : (root.barMappedPos.y + root.topEdgeOvs)) : -1
    radiusX: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.tlRadius) : 0
    radiusY: (root.isRenderable && !root.outlineHoleOnly) ? (root.isFramed ? root._minR : root.tlRadius) : 0
