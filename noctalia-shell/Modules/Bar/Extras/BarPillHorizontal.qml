...
Item {
  ...
  // When a panel is open, ignore hover state for color purposes
  // (Wayland doesn't send exit events when panel steals focus)
  readonly property bool effectiveHovered: hovered && !PanelService.openedPanel
  property color customBackgroundColor: "transparent"
  property color customBackgroundHoverColor: "transparent"
