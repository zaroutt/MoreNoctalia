...
Item {
  ...
  BarPill {
    ...
    customIconColor: root._syncIconColor.a > 0 ? root._syncIconColor : Color.resolveColorKeyOptional(root.iconColorKey)
    customBackgroundHoverColor: root._syncHoverColor
