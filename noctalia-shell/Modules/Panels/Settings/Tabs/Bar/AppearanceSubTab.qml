...
ColumnLayout {
  ...
  NValueSlider {
    Layout.fillWidth: true
    label: I18n.tr("panels.bar.appearance-capsule-group-spacing-label")
    description: I18n.tr("panels.bar.appearance-capsule-group-spacing-description")
    from: 0
    to: 30
    stepSize: 1
    showReset: true
    value: Settings.data.bar.capsuleGroupSpacing
    defaultValue: Settings.getDefaultValue("bar.capsuleGroupSpacing")
    onMoved: value => Settings.data.bar.capsuleGroupSpacing = value
    text: Settings.data.bar.capsuleGroupSpacing + "px"
  }

  NValueSlider {
    Layout.fillWidth: true
    label: I18n.tr("panels.bar.appearance-capsule-inner-padding-label")
    description: I18n.tr("panels.bar.appearance-capsule-inner-padding-description")
    from: 0
    to: 20
    stepSize: 1
    showReset: true
    value: Settings.data.bar.capsuleInnerPadding
    defaultValue: Settings.getDefaultValue("bar.capsuleInnerPadding")
    onMoved: value => Settings.data.bar.capsuleInnerPadding = value
    text: Settings.data.bar.capsuleInnerPadding + "px"
  }
  ...
  NToggle {
    Layout.fillWidth: true
    label: I18n.tr("panels.bar.appearance-show-bar-outline-label")
    description: I18n.tr("panels.bar.appearance-show-bar-outline-description")
    checked: Settings.data.bar.showBarOutline
    defaultValue: Settings.getDefaultValue("bar.showBarOutline")
    onToggled: checked => Settings.data.bar.showBarOutline = checked
  }
