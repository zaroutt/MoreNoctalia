...
SmartPanel {
  id: root
  showPanelOutline: false
  linearContentOpacity: true
  ...
  panelContent: Rectangle {
    ...
    Rectangle {
      ...
      color: Qt.alpha(Color.mSurfaceVariant, Style.effectivePanelOpacity)
      z: 1000
    ...
    Item {
      ...
      Item {
        ...
        Rectangle {
          ...
          color: (buttonRoot.isSelected || buttonRoot.effectiveHover) ? Color.mOnPrimary : Qt.alpha(Color.mSurface, Style.effectivePanelOpacity)
